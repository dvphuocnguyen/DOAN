  ...
  return (
    <div className="list_place_containter">
      <div className="place_type">
        ...
        <p className="place_type_item">Điểm tham quan</p>
        <p className="place_type_item">Coffee</p>
        ...
        <ul className="place_list">
          {places.map((place) => (
            <li key={place._id} className="place_item">
              <Link to={`/place/${place._id}`} className="place_form"> {/* Change Link URL */}
                <div className="place_img">
                  <img src={place_img} alt="place" /> {/* Add alt attribute */}
                </div>
